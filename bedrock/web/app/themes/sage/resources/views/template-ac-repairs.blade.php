        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            <div class="max-w-xl">
                <div class="flex gap-3 mb-6 items-center">
                    <div class="inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium font-geist" style="background: rgba(68, 167, 222, 0.1); color: rgb(68, 167, 222);">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
                        {{ $hero->badge }}
                    </div>
                </div>
                ...
                <h1 class="sm:text-5xl lg:text-[56px] leading-[1.05] text-4xl font-bold tracking-tight font-geist mb-6 uppercase" style="color: rgb(0, 57, 118);">
                    {{ $hero->title }}
                    <span class="block mt-2" style="color: rgb(68, 167, 222);">{{ $hero->subtitle }}</span>
                </h1>
                ...
                <div class="flex flex-col sm:flex-row sm:items-stretch gap-4 mb-12">
                    <a href="#contact" class="group inline-flex items-center transition-colors sm:w-auto justify-center font-medium text-white w-full rounded-full py-3 pr-3 pl-6 shadow-lg" style="background: #14A850;">
                        <span class="font-geist">Request Repair</span>
            ...
            <div class="relative">
                <div class="overflow-hidden rounded-[28px] relative shadow-2xl ring-1 ring-black/5">
                    <img src="{{ get_template_directory_uri() }}/public/images/ac-repairs.jpeg" alt="AC Repairs" class="w-full h-[500px] sm:h-[600px] object-cover">
                </div>
            </div>
        </div>
    </section>
