        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            <div class="max-w-xl">
                <div class="flex gap-3 mb-6 items-center">
                    <div class="inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium font-geist" style="background: rgba(220, 38, 38, 0.1); color: rgb(220, 38, 38);">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 2v10"></path><path d="M18.4 6.6a9 9 0 1 1-12.77.04"></path></svg>
                        {{ $hero->badge }}
                    </div>
                </div>
                ...
                <h1 class="sm:text-5xl lg:text-[56px] leading-[1.05] text-4xl font-bold tracking-tight font-geist mb-6 uppercase" style="color: rgb(0, 57, 118);">
                    {{ $hero->title }}
                    <span class="block mt-2" style="color: rgb(220, 38, 38);">{{ $hero->subtitle }}</span>
                </h1>
            ...
            <div class="relative">
                <div class="overflow-hidden rounded-[28px] relative shadow-2xl ring-1 ring-black/5">
                    <img src="{{ get_template_directory_uri() }}/public/images/furnace-repair.jpeg" alt="Furnace Repair" class="w-full h-[500px] sm:h-[600px] object-cover">
                </div>
            </div>
        </div>
    </section>
