  ...
  @while(have_posts()) @php the_post() @endphp
    <section class="sm:px-8 max-w-7xl mr-auto ml-auto pr-6 pb-16 pl-6 pt-12">
        <div class="max-w-3xl mx-auto text-center mb-12">
            <div class="inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium font-geist mb-6 [animation:fadeSlideIn_1s_ease-out_0.1s_both] animate-on-scroll" style="background: rgba(20, 168, 80, 0.1); color: rgb(20, 168, 80);">
