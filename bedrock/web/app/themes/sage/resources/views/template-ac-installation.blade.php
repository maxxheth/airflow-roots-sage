  ...
  @while(have_posts()) @php the_post() @endphp
    ...
    <section class="sm:px-8 max-w-7xl mr-auto ml-auto pr-6 pb-16 pl-6 pt-12">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            <div class="max-w-xl">
                ...
                <!-- Badge -->
                <div class="inline-flex items-center gap-3 bg-blue-50 border border-blue-200 [animation:fadeSlideIn_1s_ease-out_0.5s_both] animate-on-scroll rounded-2xl px-5 py-3">
            ...
            <div class="relative [animation:fadeSlideIn_1s_ease-out_0.3s_both] animate-on-scroll">
                <div class="overflow-hidden rounded-[28px] relative shadow-2xl ring-1 ring-black/5">
                    <img src="{!! Vite::asset('resources/images/ac-installation.jpeg') !!}" alt="AC Installation" class="w-full h-[500px] sm:h-[600px] object-cover">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="sm:p-8 bg-white max-w-7xl border-black/5 border rounded-3xl mt-20 mr-auto mb-20 ml-auto pt-12 pr-6 pb-12 pl-6">
        <div class="max-w-4xl mx-auto">
            <h2 class="sm:text-4xl lg:text-5xl leading-[1.05] [animation:fadeSlideIn_1s_ease-out_0.1s_both] animate-on-scroll text-3xl font-bold tracking-tight font-geist mb-6 text-center uppercase" style="color: rgb(0, 57, 118);">
                {{ $needs->title }}
            </h2>
            <p class="text-lg text-neutral-700 leading-relaxed text-center [animation:fadeSlideIn_1s_ease-out_0.2s_both] animate-on-scroll font-geist mb-10">
                {{ $needs->description }}
            </p>

            <!-- Signs Grid -->
            <div class="mt-12">
                <h3 class="text-2xl font-semibold tracking-tight font-geist [animation:fadeSlideIn_1s_ease-out_0.3s_both] animate-on-scroll mb-8 text-center uppercase" style="color: rgb(0, 57, 118);">{{ $needs->signsTitle }}</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    @php
                        $signs = [
                            ['icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#003976" stroke-width="1.5"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>', 'title' => 'System Age Over 10-15 Years', 'desc' => 'Older units are less efficient and more prone to breakdowns', 'delay' => '0.4s'],
                            ['icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#003976" stroke-width="1.5"><path d="M12 2v20M2 12h20"></path></svg>', 'title' => 'Frequent Repairs', 'desc' => 'Constant breakdowns and costly repair bills', 'delay' => '0.5s'],
                            ['icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#003976" stroke-width="1.5"><line x1="12" x2="12" y1="2" y2="22"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>', 'title' => 'Rising Energy Bills', 'desc' => 'Inefficient systems cost more to operate', 'delay' => '0.6s'],
                            ['icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#003976" stroke-width="1.5"><path d="M14 4v10.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0Z"></path></svg>', 'title' => 'Inconsistent Temperatures', 'desc' => 'Some rooms too hot while others are too cold', 'delay' => '0.7s'],
                            ['icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#003976" stroke-width="1.5"><path d="M2 16.1A5 5 0 0 1 5.9 20M2 12.05A9 9 0 0 1 9.95 20M2 8V6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-6"></path><line x1="2" x2="2.01" y1="20" y2="20"></line></svg>', 'title' => 'Excessive Noise', 'desc' => 'Loud or unusual sounds from the unit', 'delay' => '0.8s'],
                            ['icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#003976" stroke-width="1.5"><path d="M17.7 7.7a2.5 2.5 0 1 1 1.8 4.3H2"></path><path d="M9.6 4.6A2 2 0 1 1 11 8H2"></path><path d="M12.6 19.4A2 2 0 1 0 14 16H2"></path></svg>', 'title' => 'Poor Air Quality', 'desc' => 'Excess dust, humidity, or poor ventilation', 'delay' => '0.9s'],
                        ];
                    @endphp

                    @foreach($signs as $sign)
                        <div class="flex items-start gap-3 bg-blue-50 border border-blue-200 [animation:fadeSlideIn_1s_ease-out_{{ $sign['delay'] }}_both] animate-on-scroll rounded-2xl p-5">
