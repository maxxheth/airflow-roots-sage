{{--
  ...
  The main homepage template for Airflow HVAC
--}}
...
@section('content')
  @while(have_posts()) @php the_post() @endphp
            ...
            <div class="max-w-xl">
                ...
                <div class="flex gap-3 mb-6 items-center [animation:fadeSlideIn_1s_ease-out_0.1s_both] animate-on-scroll">
                    <div class="inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium font-geist" style="background: rgba(20, 168, 80, 0.1); color: rgb(20, 168, 80);">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M20 6 9 17l-5-5"></path></svg>
                        30+ Years Experience
                    </div>
                    <div class="inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium font-geist" style="background: rgba(0, 57, 118, 0.1); color: rgb(0, 57, 118);">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 6v12"></path><path d="M17.196 9 6.804 15"></path><path d="m6.804 9 10.392 6"></path></svg>
                        24/7 Service
                    </div>
                </div>
                ...
                {{-- CTAs --}}
                <div class="flex flex-col sm:flex-row sm:items-stretch gap-4 [animation:fadeSlideIn_1s_ease-out_0.4s_both] animate-on-scroll mb-12 items-start">
                ...
                {{-- Certifications --}}
                <div class="[animation:fadeSlideIn_1s_ease-out_0.5s_both] animate-on-scroll">
                    <p class="text-sm text-neutral-500 mb-4 font-geist">Certified & Trusted</p>
                    <div class="flex gap-6 sm:gap-8 items-center opacity-60">
                        <div class="flex items-center gap-2 px-4 py-2 rounded-lg bg-neutral-50 ring-1 ring-neutral-200">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" style="color: #003976;"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"></path></svg>
                            <span class="text-xs font-medium font-geist">NATE Certified</span>
                        </div>
                        <div class="flex items-center gap-2 px-4 py-2 rounded-lg bg-neutral-50 ring-1 ring-neutral-200">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" style="color: #14A850;"><path d="m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275L12 3Z"></path></svg>
                            <span class="text-xs font-medium font-geist">Energy Star</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="services" class="sm:p-8 bg-white max-w-7xl border-black/5 border rounded-3xl mt-20 mr-auto mb-20 ml-auto pt-12 pr-6 pb-12 pl-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-10">
            @foreach($services as $service)
                @include('partials.service-card', (array)$service)
            @endforeach
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto relative">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                @foreach($features as $feature)
                    @include('partials.feature-card', (array)$feature)
                @endforeach
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                @foreach($testimonials as $testimonial)
                    @include('partials.testimonial-card', (array)$testimonial)
                @endforeach
            </div>

            <div class="text-center mt-10 [animation:fadeSlideIn_1s_ease-out_0.4s_both] animate-on-scroll">
                <a href="#reviews" class="inline-flex items-center gap-2 font-medium text-base font-geist" style="color: rgb(0, 57, 118);">
                    Read More Reviews on Google
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
                </a>
            </div>
        </div>
    </section>
    ...
    {{-- Our Process Section --}}
    <section id="process" class="lg:px-8 sm:px-8 max-w-7xl mr-auto ml-auto mt-20 mb-20 pt-20 pr-6 pb-20 pl-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mt-10">
            @foreach($processSteps as $step)
                @include('partials.process-step', (array)$step)
            @endforeach
        </div>
    </section>
