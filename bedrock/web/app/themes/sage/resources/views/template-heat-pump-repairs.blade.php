{{--
  Template Name: Heat Pump Repairs
--}}
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            ...
            <div class="relative">
                <div class="overflow-hidden rounded-[28px] relative shadow-2xl ring-1 ring-black/5">
                    <img src="{{ get_template_directory_uri() }}/public/images/heat-pump-repairs.jpeg" alt="Heat Pump Repairs" class="w-full h-[500px] sm:h-[600px] object-cover">
                </div>
            </div>
        </div>
    </section>
