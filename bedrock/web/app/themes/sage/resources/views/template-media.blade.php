  ...
  @while(have_posts()) @php(the_post())
    <section class="sm:px-8 max-w-7xl mr-auto ml-auto pr-6 pb-16 pl-6 pt-12">
        <div class="max-w-3xl mx-auto text-center mb-12">
            <div class="inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium font-geist mb-6" style="background: rgba(6, 182, 212, 0.1); color: rgb(6, 182, 212);">
